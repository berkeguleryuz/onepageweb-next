  ...
  return (
    <header className="flex justify-center items-center relative top-3">
      <nav className="flex gap-1 p-0.5 border border-white/15 bg-white/10 backdrop-blur rounded-full">
        ...
        <Link
          className="px-4 py-1.5 rounded-full text-white/70 hover:text-neutral-950 text-sm font-semibold bg-white text-neutral-950 hover:bg-white/70 transition duration-300"
          href={"#"}>
          Contact
        </Link>
      </nav>
