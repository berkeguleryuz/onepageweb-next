    ...
    <section className="py-16 lg:py-24">
      <div className="container">
        ...
        <div className="flex flex-col md:mt-20 mt-10 gap-8">
          {/* 1 */}
          <div className="bg-neutral-800 border rounded-3xl relative after:content-[''] after:absolute after:inset-0 after:outline-2 after:outline  after:oufline-offset-2 after:rounded-3xl z-0 after:z-10 overflow-hidden after:outline-white/20 p-6 after:pointer-events-none h-[320px] ">
            <div
          ...
          {/* 3 */}
          <div className="bg-neutral-800 border rounded-3xl relative after:content-[''] after:absolute after:inset-0 after:outline-2 after:outline  after:oufline-offset-2 after:rounded-3xl z-0 after:z-10 overflow-hidden after:outline-white/20 after:pointer-events-none h-[320px] flex flex-col p-6">
            <div
              className="absolute inset-0 -z-10 opacity-10"
              style={{ backgroundImage: `url(${grainImage.src})` }}></div>
            <div className="flex flex-col gap-2 font-bold uppercase items-center justify-center tracking-widest">
          ...
          {/* 4 */}
          <div className="bg-neutral-800 border rounded-3xl relative after:content-[''] after:absolute after:inset-0 after:outline-2 after:outline  after:oufline-offset-2 after:rounded-3xl z-0 after:z-10 overflow-hidden after:outline-white/20 p-0 after:pointer-events-none h-[320px]">
            <div
              className="absolute inset-0 -z-10 opacity-10"
              style={{ backgroundImage: `url(${grainImage.src})` }}></div>
            <Image
